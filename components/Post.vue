        ...
        <div class="py-2 w-full">
            <div class="flex items-center justify-between">
                ...
                <div @click="isMenu = !isMenu" class="relative">
                    <button
                        :disabled="isDeleting"
                        class="flex items-center text-white p-1 h-[24px] w-[24px] hover:bg-gray-50 rounded-full cursor-pointer"
                ...
                <div v-if="isMenu" class="absolute border border-gray-600 right-0 z-20 mt-1 rounded">
                    <button class="flex items-center rounded gap-2 text-red-500 justify-between bg-black w-full pl-4 pr-3 py-1 hover:bg-blue-gray-900">
                        <div>Delete</div>
